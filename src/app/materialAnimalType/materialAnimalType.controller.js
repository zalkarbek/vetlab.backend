...
class MaterialAnimalTypeController extends Controller {

  constructor() {
    super();
    this.modelName = 'sMaterialAnimalType';
    this.i18nUnitOne = 'animal.type.one';
    this.i18nUnitMany = 'animal.type.many';
  }
...
module.exports = new MaterialAnimalTypeController();
